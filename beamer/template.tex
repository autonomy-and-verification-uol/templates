...
{%
  \hbox{%
    \begin{beamercolorbox}[wd=0.4\textwidth,ht=2.5ex,dp=1.5ex,leftskip=.5em,rightskip=.5em]{author 
        in head/foot}%
      \usebeamerfont{author in head/foot}%
      \insertframenumber/\inserttotalframenumber\hfill\insertshortauthor%
    \end{beamercolorbox}%
    \begin{beamercolorbox}[wd=0.6\textwidth,ht=2.5ex,dp=1.5ex,left,leftskip=.5em,rightskip=.5em]{title 
        in head/foot}%
...
\date{Date of Talk}
% set university logo
\titlegraphic{\includegraphics[height=0.7cm]{UoL-Logo}}
